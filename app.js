...
개인정보 보호법은 직접 해킹이나 유출을 저지른 사람뿐만 아니라, 어둠의 경로(메신저, 암거래 시장)에서 불법 유출된 데이터임을 알면서도 '영리 목적(마케팅·영업·재판매)'으로 사들이거나 제공받은 사람 역시 동일하게 징역형으로 엄벌합니다. '단순 홍보용 연락처'라는 핑계는 면책 사유가 되지 않습니다.`,
    ...
    },
    {
      ...
      story: `과거 어떠한 범죄 전력도 없던 <b>피고인 A씨</b>는 SNS를 둘러보던 중 왜곡된 성적 호기심과 <b>"인터넷 익명 뒤에 숨으면 아무에게도 들키지 않을 것"</b>이라는 삐뚤어진 생각에 사로잡혔습니다. A씨는 평소 알고 지내던 중학교 후배 <b>B씨(16세)</b>와 중학교 동창 <b>C씨(18세)</b>의 인스타그램에 접속해, 피해자들이 일상에서 밝게 웃으며 올린 프로필 사진과 일상 사진들을 몰래 캡처하여 수집했습니다.

A씨는 트위터(X)에서 암암리에 활동하는 딥페이크 전문 합성업자에게 접근하여 피해자들의 얼굴 사진을 건네며, 여성의 나체 및 노골적인 성관계 사진과 정교하게 합성해 달라고 의뢰했습니다. A씨는 이러한 수법으로 <b>총 28회(미성년자 성착취물 5회, 허위영상물 23회)</b>에 걸쳐 지인들의 얼굴이 합성된 불법 딥페이크 성착취물을 제작·전송받아 자신의 스마트폰에 저장했습니다. 또한 <b>30회에 걸쳐 아동·청소년 성착취물을 다운로드받아 소지</b>했을 뿐만 아니라, SNS 지인 능욕방 입장 자격을 얻기 위해 지인들의 신상정보까지 팔아넘겼습니다.
...
범행의 대담함은 여기서 멈추지 않았습니다. 최근 생성형 AI 기술이 급격히 확산되던 <b>2024년 어느 날</b>, A씨는 낮에 대학교 강의실에서 함께 수업을 듣고 과제를 하던 <b>같은 과 여자 동기들의 얼굴 사진을 SNS에서 몰래 캡처</b>했습니다. 그러고는 밤마다 AI 프로그램을 이용해 타인의 나체 사진과 정교하게 합성한 <b>195개의 딥페이크 허위영상물을 직접 제작</b>하여 자신의 스마트폰 비밀 폴더에 장기간 소장했습니다.
