...
document.addEventListener('DOMContentLoaded', () => {
  // -------------------------------------------------------------
  // 1. 사건 사례 데이터 정의 (가중/감경 요소 100% 매칭 스토리 & 팩트 법조문 & 구체적 판례/수치)
  // -------------------------------------------------------------
  const caseData = [
    {
      id: 'case-1',
      ...
      story: `웹툰 작가 **A씨(31세)**는 유료 웹툰 플랫폼에서 3년째 판타지 장르 웹툰을 연재해 온 프리랜서 창작자입니다. 과거 형사 처벌이나 저작권 침해 이력이 전혀 없는 초범이었지만, 독자들의 반응은 냉담했고 최근 작품 인기 순위가 100위권 밖으로 곤두박질치면서 플랫폼 매니저로부터 "다음 달까지 조회수가 회복되지 않으면 계약을 해지할 수밖에 없다"는 일종의 통보를 받게 됩니다. 당장 밀린 월세와 다음 달 생계가 막막해진 A씨는 극심한 불안감 속에서 절박한 생계형 동기로 범행을 결심하게 됩니다.

절박해진 A씨는 인기를 단숨에 끌어올릴 핵심 캐릭터를 투입하기로 마음먹고 최신 이미지 생성 AI 기술을 떠올렸습니다. A씨는 글로벌 콘텐츠 기업 디즈니의 메가 히트작 대표 캐릭터인 **'루나'**의 모든 디자인 특성(특유의 오색 눈동자, 독특한 제복 의상 깃, 헤어 스타일, 표정과 톤)이 담긴 고화질 이미지 300여 장을 AI 프롬프트 및 미세조정(LoRA) 학습 데이터로 무단 입력하며 고의적인 모작을 유도했습니다. A씨는 AI 결과를 그대로 쓰지 않고 세부 의상 패턴과 일부 대사를 자체적으로 변형하려는 시도를 거쳐 신규 주인공 캐릭터를 생성했습니다.

이 캐릭터의 등장으로 웹툰은 12위까지 급상승했고, A씨는 단발성이 아닌 유료 회차 10여 회에 걸쳐 지속적인 노출 연재를 이어가며 대기업 굿즈 제작사와 캐릭터 상품화 계약까지 앞두게 되어 직접적인 상업적 이익을 창출했습니다.

한편, 디즈니 한국지사 캐릭터 디자이너 **B씨**는 퇴근 후 취미로 웹툰을 보다가 자신의 피땀 어린 5년 차 대표 창작물 '루나'를 베낀 듯한 캐릭터를 발견하고 충격에 휩싸입니다. B씨는 브랜드 가치 훼손과 극심한 정신적 고통을 호소했고 회사를 통해 A씨를 고소했습니다. 

고소당한 직후 A씨는 심각성을 깨닫고 인지 즉시 해당 캐릭터 등장 분량을 삭제하고 연재를 전면 중단했습니다. 수사 과정에서 자신의 범행을 솔직히 인정하고 자필 사과문을 올리며 깊이 반성했으나, 원작자 B씨 및 디즈니 측과의 민·형사상 합의에는 끝내 이르지 못했습니다.`,
      ...
      aggregatingFactors: [
        ...
        { id: 'agg4', text: '지속적인 침해 행위 (단발성이 아닌 유료 회차 10여 회 정기 노출 및 상업 연재)' },
...
• <i>(참고: 2024년 성폭력처벌법 개정으로 단순 소지·시청 시 <b>징역 3년 이하 / 벌금 3,000만 원 이하</b>, 반포 시 <b>최대 징역 7년</b>으로 처벌 상한 강화)</i>`,
    ...
    },
    {
      ...
      story: `IT 벤처 기업을 운영하는 AI 스타트업 대표 **A씨(36세)**는 과거 개인정보 보호법 위반 범죄 전력이 없는 초범 사업가였습니다. 당시 AI 산업계에서는 공개된 데이터 학습에 관한 법적 가이드라인이 명확히 수립되지 않은 모호성이 존재했습니다.

A씨는 정당한 동의 절차 대신, 해킹이 아닌 인터넷에 전체 공개된 블로그와 SNS의 얼굴 사진 50만 건 및 작성 게시글을 무단 수집했습니다. A씨는 수집한 원본 사진 자체를 외부에 직접 유출하진 않았으나, 50만 건의 대규모 개인정보를 AI 신경망 가중치에 통합시켜 상상 상용 솔루션으로 제작·판매함으로써 **약 2억 원의 막대한 상업적 매출**을 올렸습니다.

쇼핑몰 전광판에서 자신의 과거 게시글 기반 성향 분석 결과가 노출되어 극심한 사생활 침해와 불안감을 느낀 피해자 **B씨(24세)**가 삭제 및 AI 모델 파기를 요구했으나, A씨는 "신경망 가중치로 이미 학습되어 영구 삭제가 기술적으로 불가능하다"며 삭제 거부를 통보했습니다.

B씨의 고소로 수사가 시작되자 A씨는 기술 알고리즘 구조를 공개하며 수사에 적극 협조했고 향후 필터링 시스템 도입을 약속하며 재발 방지 노력을 표명했습니다.`,
...
<small style="color:#78350f;">※ 개인정보보호위원회는 전체 매출액의 3% 이하에 해당하는 과징금 부과 및 수집 데이터 전량 파기 명령을 조치할 수 있습니다.</small>`,
      ...
      stdVerdict: {
        ...
        prison: '징역 1년',
        probation: '집행유예 2년',
        summaryText: '벌금(배상금) 1,500만 원 (또는 징역 1년 / 집행유예 2년 + 과징금 및 데이터 파기 명령)',
        recognizedAgg: ['agg1', 'agg2', 'agg3', 'agg4', 'agg5'],
        recognizedMit: ['mit1', 'mit3', 'mit4', 'mit5']
      },
...
<b>2. 클리어뷰 AI (Clearview AI) 안면 인식 알고리즘 (영국 ICO 행정처분 및 미국 민사 합의):</b><br>
인터넷·SNS에서 일반인 수십억 명의 얼굴 사진을 크롤링하여 안면 인식 DB 구축 및 판매함.<br>
• <b>영국(ICO):</b> 개인정보 침해 <b>벌금 750만 파운드 (약 120억 원) 부과</b> 및 데이터 파기 명령<br>
• <b>미국(집단소송 합의):</b> 민간 기업 대상 안면 인식 DB 유료 판매 전면 금지 및 피해자 집단소송 측에 <b>회사 지분 평가액 기준 약 $5,000만 (약 680억 원) 상당 주식 지급 합의</b><br><br>
