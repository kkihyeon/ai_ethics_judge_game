  ...
  const caseData = [
    {
      ...
      summary: '인기 순위 100위 밖으로 밀려난 작가 A씨가 AI로 디즈니 인기 캐릭터를 모작한 후 고소당했으나, 재판 과정에서 범행을 자백하고 합의금 3,000만 원을 지급하며 극적으로 합의한 사건',
      story: `웹툰 작가 <b>A씨(31세)</b>는 유료 웹툰 플랫폼에서 3년째 판타지 장르 웹툰을 연재해 온 프리랜서 창작자입니다. 과거 저작권 침해나 형사 처벌 이력이 전혀 없는 초범이었지만, 최근 작품 인기 순위가 100위권 밖으로 곤두박질치면서 "다음 달까지 조회수가 회복되지 않으면 계약을 해지하겠다"는 통보를 받게 됩니다. 당장 생계가 막막해진 A씨는 극심한 불안 속에서 절박한 생계형 동기로 AI 모작을 결심하게 됩니다.

A씨는 디즈니의 메가 히트작 대표 캐릭터인 <b>'루나'</b>의 모든 디자인 특성(오색 눈동자, 제복 의상 깃, 헤어 스타일, 표정)이 담긴 고화질 이미지 300여 장을 AI 프롬프트 및 미세조정(LoRA) 학습 데이터로 무단 입력하며 고의적인 모작을 유도했습니다. A씨는 세부 의상 패턴 일부와 대사를 자체 변형하려 시도하긴 했으나, 누가 봐도 '루나'의 외형과 독창적 특성이 그대로 반영된 신규 주인공 캐릭터를 생성했습니다.

이 캐릭터의 등장으로 웹툰은 단 일주일 만에 12위까지 급상승했고, A씨는 단발성이 아닌 유료 회차 10여 회에 걸쳐 정기 연재를 이어가며 대기업 굿즈 제작사와 캐릭터 상품화 계약까지 추진해 약 3,500만 원 상당의 상업적 이익을 챙겼습니다.

디즈니 한국지사 디자이너 <b>B씨</b>가 이를 발견하고 브랜드 가치 훼손과 정신적 고통을 호소하며 회사를 통해 A씨를 정식 고소했습니다.

초기 고소 단계에서 A씨는 "AI 생성물이라 창작 영역"이라며 반발했으나, 경찰 조사와 재판이 본격화되자 자신의 잘못을 깊이 뉘우쳤습니다. A씨는 해당 캐릭터 등장 분량을 삭제하고 연재를 중단했으며, 원작자 B씨와 디즈니 측에 <b>합의금 3,000만 원을 지급하고 민·형사상 처벌불원서 합의 타결</b>을 이루어냈습니다.`,
      suspectArg: '"처음에는 절박한 마음에 AI 창작 영역이라 주장하며 불응했으나 깊이 반성합니다. 해당 회차를 모두 삭제 조치하였고, 피해자분께 합의금 3,000만 원을 지급하여 원만히 합의를 완료했습니다."',
      victimArg: '"원작 캐릭터 300여 장을 AI에 무단 학습시켜 도용했으나, 피고인이 범행을 인정하고 3,000만 원의 손해배상금을 지급하며 사과하였기에 처벌불원 합의에 응했습니다."',
      
      aggregatingFactors: [
        { id: 'agg1', text: '상업적 이익 창출 (순위 상승 100위➔12위 및 굿즈 계약 추진 등 약 3,500만 원 매출 이득)' },
        { id: 'agg2', text: '고의적인 모작 유도 (AI 학습 데이터 및 프롬프트에 원작 캐릭터 300여 장 의도적 입력)' },
        { id: 'agg3', text: '지속적인 침해 행위 (단발성이 아닌 유료 회차 10여 회 정기 노출 및 상업 연재)' },
        { id: 'agg4', text: '원작자 상실감 및 피해 규모 (글로벌 IP 브랜드 가치 훼손 및 창작자 정신적 고통 유발)' },
        { id: 'agg5', text: '초기 대응 불응 (초기 고소 단계에서 AI 창작물이라 주장하며 삭제 거부 및 연재 지속)' }
      ],
      mitigatingFactors: [
        { id: 'mit1', text: '원작자와의 원만한 합의 완료 (피해자 B씨에게 합의금 3,000만 원 지급 및 처벌불원서 제출)' },
        { id: 'mit2', text: '동종 전과 없음 (어떠한 형사 처벌이나 저작권 침해 이력이 없는 초범)' },
        { id: 'mit3', text: '절박한 생계형 동기 (연재 중단 및 계약 해지 위기라는 압박 속 범행)' },
        { id: 'mit4', text: '사후 즉시 삭제 조치 (재판 과정에서 해당 캐릭터 등장 분량 전량 삭제 및 연재 중단)' },
        { id: 'mit5', text: '범행 인정 및 깊은 반성 (자신의 잘못을 솔직히 자백하고 깊이 뉘우침)' }
      ],
...
<small style="color:#78350f;">※ 피해자와 3,000만 원 상당의 처벌불원 합의가 완성되고 콘텐츠를 삭제·반성한 경우 벌금형 또는 집행유예 감경이 적용됩니다.</small>`,

      stdVerdict: {
        fine: '700만 원 이하',
        prison: '징역 6개월',
        probation: '집행유예 1년',
        summaryText: '벌금(배상금) 700만 원 (또는 징역 6개월 / 집행유예 1년)',
      ...
      caseName: '웹툰 AI 캐릭터 무단 학습 모작 및 상업 연재 저작권 침해 사건',
      orderText: '피고인을 벌금 7,000,000원에 처한다. (또는 징역 6개월에 처하며 이 판결 확정일부터 1년간 위 형의 집행을 유예한다.)',
      reasonText: `<b>1. 가중 사유 (수치 참작):</b> 피고인은 타인의 캐릭터 이미지 300여 장을 고의로 AI에 학습시켜 모작을 유도하였고, 웹툰 인기 순위 급상승(100위 ➔ 12위) 및 유료 회차 10여 회 정기 연재를 통해 약 3,500만 원 상당의 상업적 매출 이득을 취함.
      
<b>2. 감경 사유 (수치 참작):</b> 피고인이 이전 범죄 전력이 없는 초범인 점, 계약 해지 위기라는 생계형 동기가 참작되는 점, 재판 과정에서 자신의 잘못을 솔직히 자백하고 해당 콘텐츠를 전량 삭제 조치하였으며, 피해자 B씨에게 합의금 3,000만 원을 지급하고 민·형사상 원만한 합의(처벌불원서 제출)를 완성한 점(형법 제51조 범행 후 정황)을 종합 고려하여 벌금형(또는 집행유예)으로 감경함.`,
      
      realJudge: `<b>🏛️ 실제 판결·처분 수치 및 법적 결과:</b><br><br>
<b>1. 디즈니·유니버설 vs 미드저니 소송 (미국 캘리포니아 연방법원):</b><br>
미드저니가 '스타워즈', '심슨', '슈렉' 등 저작권 캐릭터를 사전 승인 없이 무단 학습 후 생성·판매함.<br>
• <b>청구 배상액:</b> 저작권 침해 1건당 <b>최대 $150,000 (약 2억 원)</b><br>
• <b>총 청구 규모:</b> 150여 개 대상 작품에 대해 <b>총 $2,000만 (약 270억 원) 이상의 손해배상</b> 및 침해 금지 가처분 청구<br><br>
<b>2. AI 생성물 무단 복제·상업 이용 사건 (일본 수사기관 형사 송치):</b><br>
타인이 오랜 프롬프트 조정으로 제작한 캐릭터를 복제하여 상업용 책 표지로 무단 판매함.<br>
• 프롬프트 엔지니어링의 창작성을 인정하여 AI 생성물에 대한 저작권(복제권) 침해 인정.<br>
• 피의자를 저작권법 위반 혐의로 <b>검찰에 형사 송치</b> (일본 저작권법상 <b>최대 징역 10년 또는 1,000만 엔 이하 벌금</b> 부과 대상)<br><br>
<b>3. 스태빌리티 AI 저작물 침해 소송 (미국 캘리포니아 북방법원):</b><br>
원작자들의 등록 저작물 및 게티이미지(Getty Images) 수억 건의 이미지를 무단 학습 및 유사 출력함.<br>
• 원작자의 등록 저작물 직접 침해 혐의 재판 진행 승인.<br>
• 게티이미지 측 청구액: 침해 건당 <b>$150,000 (약 2억 원)</b>, 총 청구액 <b>수조 원대 (최대 $1조 8,000억 상당) 손해배상 청구 중</b>`,
      
      lawSummary: `<b>📌 대법원 판례 확립 원칙 (합의 및 자발적 삭제 시 감경):</b><br>AI 생성물이라도 원작과의 실질적 유사성이 인정되면 처벌 대상이나, 피해자와 3,000만 원 상당의 민·형사 합의를 성사시키고 사후 삭제 조치를 이행한 경우 형량이 참작되어 벌금형이나 집행유예가 선고됩니다.`,
      lessonQuote: `"AI를 통한 무단 도용이 발생했더라도, 자신의 잘못을 인정하고 피해자에게 성의 있는 보상과 합의를 다하는 것이 법적 책임을 줄이는 길입니다."`
    },
    {
      id: 'case-2',
      category: '사용자 / 인격권',
      ...
      story: `수도권 대학 컴퓨터공학과 3학년에 재학 중인 <b>A씨(22세)</b>는 평소 어떠한 형사 처벌이나 범죄 전력이 없는 초범 학생이었습니다. 하지만 최근 생성형 AI 영상 편집 및 딥페이크(Deepfake) 이미지 합성 기술에 깊이 매료되어 자신의 컴퓨터공학 전공 지식과 디지털 매체의 복제·유포 위험성을 충분히 인지할 수 있는 위치에 있었습니다.

동기들과의 단체 채팅방에서 자신의 컴퓨터 기술력을 과시하고 싶었던 A씨는 금전적 이득을 취할 목적이 아닌 단순 호기심과 장난으로 학과 동기 <b>B씨(22세, 여)</b>의 얼굴 사진을 다운로드했습니다. A씨는 AI 프로그램으로 B씨의 동의 없이 성적 수치심을 유발하는 허위 음란성 딥페이크 영상물을 제작했습니다. 그리고 자신의 인스타그램 부계정 스토리(팔로워 150명)에 올리며 불특정 다수에게 공개 노출시켰습니다.

영상을 올린 직후 불안감을 느낀 A씨는 <b>게시 5분 만에 자발적이고 신속하게 스토리에서 삭제</b>하였고, 추가 2차 유포를 막기 위해 컴퓨터 내 원본 사진 및 합성 프로젝트 데이터 파일 일체를 즉시 파기했습니다. 

그러나 불과 5분 사이에 한 팔로워가 스토리를 캡처해 피해자 B씨에게 전달했습니다. 성적 수치심과 공포감으로 B씨는 대인기피증과 정신과 치료에 시달리며 결국 학업을 이어가지 못한 채 휴학계를 제출하는 등 극심한 피해를 입게 되었습니다. A씨는 수사 과정에서 범행을 순순히 자백하고 깊이 뉘우쳤으며 피해자 측에 사죄했으나, 피해자 및 보호자로부터 끝내 용서받지 못하여 합의에 이르지 못했습니다.`,
...
<small style="color:#78350f;">※ 영리 목적인 경우 3년 이상의 유기징역, 구입·소지·저장·시청한 자도 3년 이하 징역 또는 3천만 원 이하 벌금에 처해집니다.</small>`,
      ...
      reasonText: `<b>1. 가중 사유 (수치 참작):</b> 피고인은 팔로워 150명의 SNS 스토리에 음란성 딥페이크 영상을 가공·업로드하여 불특정 다수 노출 위험을 초래함. 피해자가 수치심과 대인기피증으로 6개월 이상 정신과 치료를 받고 대학 휴학계를 제출하는 등 심각한 인격적 피해를 입었고 민사 합의금(약 4,000만 원 상당) 및 처벌을 요구함.
      
<b>2. 감경 사유 (수치 참작):</b> 피고인이 영상 게시 후 단 5분 만에 자발적으로 삭제하였고 원본 프로젝트 파일 100%를 즉시 파기하여 추가 2차 확산을 막으려 노력한 점, 초범 대학생으로 수사 과정에서 전면 자백하고 반성하는 정황(형법 제51조)을 고려하여 벌금형 대신 집행유예 징역형을 선고함.`,
...
• <i>(2024년 성폭력처벌법 개정으로 단순 소지·시청 시 <b>징역 3년 이하 / 벌금 3,000만 원 이하</b>, 반포 시 <b>최대 징역 7년</b>으로 처벌 상한 강화)</i>`,
    ...
    },
    {
      ...
      story: `IT 벤처 기업을 운영하는 AI 스타트업 대표 <b>A씨(36세)</b>는 과거 동의 없는 동종 개인정보 무단 수집 및 이용으로 형사 처벌 및 행정처분을 받은 적이 있는 <b>개인정보 보호법 위반 동종 전과 재범자</b>입니다. 

A씨는 정당한 동의 절차나 라이선스 구매 비용을 지불하는 대신, 웹 크롤링 자동화 프로그램을 제작하여 일반인 수십만 명이 전체 공개로 올린 인스타그램, 네이버 블로그 등의 <b>얼굴 사진 50만 건</b>과 개인 작성 게시글 텍스트 데이터를 무단 수집했습니다. A씨는 이 50만 건의 개인정보를 AI 신경망 가중치에 학습시켰고, 개발된 안면 인식 솔루션을 대형 쇼핑몰 및 보안 업체에 판매하여 <b>약 2억 원의 막대한 상업적 매출</b>을 올렸습니다.

쇼핑몰 전광판에서 자신의 과거 게시글 기반 성향 분석 결과가 노출되어 극심한 사생활 침해와 불안감을 느낀 피해자 <b>B씨(24세)</b>가 데이터 삭제 및 AI 모델 파기를 요구했으나, A씨는 "신경망 가중치로 이미 학습되어 영구 삭제가 기술적으로 불가능하다"며 핑계를 대고 삭제를 거부했습니다.

B씨의 고소로 경찰 수사가 개시된 이후에도 A씨의 태도는 불량했습니다. A씨는 "알고리즘 및 신경망 가중치는 회사의 핵심 영업비밀이므로 제출할 수 없다"라며 <b>수사 기관의 자료 제출 요구 및 수사 협조를 전면 거부</b>하였습니다. A씨는 수사 과정에서도 반성하는 모습을 보이지 않았습니다.`,
...
<small style="color:#78350f;">※ 동종 전과가 있는 재범이고 수사 협조를 거부한 경우, 집행유예 없이 <b>징역형 실형 선고</b> 및 대규모 과징금이 부과됩니다.</small>`,
      ...
      reasonText: `<b>1. 가중 사유 (수치 참작):</b> 피고인은 동종 개인정보 보호법 위반 형사 전력이 있는 재범임에도 불구하고 50만 건이라는 대규모 개인정보 사진 및 텍스트를 무단 수집·학습시켜 약 2억 원의 막대한 상업적 매출을 올림. 특히 피해자의 삭제 요구를 거부하고 수사기관의 알고리즘 100% 제출 요구를 영업비밀 핑계로 거부하며 반성하지 않음.
      
<b>2. 감경 사유 (수치 참작):</b> 수집된 데이터가 전체 공개 게시물이었던 사정을 고려하더라도, 50만 건의 무단 크롤링 규모와 2억 원의 매출, 동종 전과 재범 및 수사 미협조로 인해 집행유예를 부여할 수 없으며 징역 2년의 법정 구속 실형 및 과징금 1억 원 부과를 선고함.`,

      realJudge: `<b>🏛️ 실제 판결·처분 수치 및 법적 결과:</b><br><br>
<b>1. AI 챗봇 '이루다' 개발사 스캐터랩 (행정처분 및 서울동부지방법원 민사 판결):</b><br>
연인 간 대화록 93억 건을 동의 없이 무단 수집·가공하여 AI 모델 학습에 이용함.<br>
• <b>행정 처분:</b> 개인정보위 <b>과징금 5,550만 원 + 과태료 4,780만 원 (총 1억 330만 원) 부과</b><br>
• <b>민사 손해배상:</b> 원고 승소, 피해자 1인당 <b>10만 원 ~ 40만 원 위자료 지급 판결</b> (일반 10만 원 / 민감 30만 원 / 중복 40만 원)<br><br>

<b>2. 클리어뷰 AI (Clearview AI) 안면 인식 알고리즘 (영국/미국 처분):</b><br>
• <b>영국(ICO):</b> 개인정보 침해 <b>벌금 750만 파운드 (약 120억 원) 부과</b> 및 데이터 파기 명령<br><br>

<b>3. 초상권 및 개인정보 무단 도용 사건 (국내 법원 민사 판결):</b><br>
일반인의 사진·영상을 동의 없이 AI 학습 데이터로 수집 후 기업용 솔루션 제작에 활용함.<br>
• <b>인격권·초상권 침해 인정:</b> 무단 도용 건수 및 상업적 활용 규모에 따라 <b>1인당 100만 원 ~ 500만 원 위자료 지급 판결</b><br>
• 무단 사용으로 창출한 사업 수익에 대해 <b>부당이득 반환 및 부당이익 환수 책임을 명시</b>`,
  ...
  // -------------------------------------------------------------
  // Helper: 파싱 보조 함수 (마크다운 **를 <b>로 안전 변환)
  // -------------------------------------------------------------
    ...
    caseData.forEach((c, idx) => {
      ...
      card.innerHTML = `
        <div>
          ...
          <p class="case-card-desc">${parseBold(c.summary)}</p>
        </div>
  ...
  function startTrial(caseId) {
    ...
    trialStoryBody.innerHTML = parseBold(currentCase.story).replace(/\n\n/g, '<br><br>');
    trialSuspectArg.innerHTML = parseBold(currentCase.suspectArg);
    trialVictimArg.innerHTML = parseBold(currentCase.victimArg);
    guideLawContent.innerHTML = parseBold(currentCase.lawGuide);
  ...
  function calculateAndShowResult(fine, prison, probation) {
    ...
    vReasonText.innerHTML = parseBold(currentCase.reasonText).replace(/\n/g, '<br>');
    if (vRealJudge) {
      vRealJudge.innerHTML = parseBold(currentCase.realJudge);
    }
    vLawSummary.innerHTML = parseBold(currentCase.lawSummary);
    resultLessonQuote.textContent = parseBold(currentCase.lessonQuote);
