...
document.addEventListener('DOMContentLoaded', () => {
  // -------------------------------------------------------------
  // 1. 사건 사례 데이터 정의 (Case 1 합의 완료 반영 & reasonText 수치 데이터 정밀 강화)
  // -------------------------------------------------------------
  const caseData = [
    {
      id: 'case-1',
      ...
      story: `웹툰 작가 **A씨(31세)**는 유료 웹툰 플랫폼에서 3년째 판타지 장르 웹툰을 연재해 온 프리랜서 창작자입니다. 과거 저작권 침해나 형사 처벌 이력이 전혀 없는 초범이었지만, 최근 작품 인기 순위가 100위권 밖으로 곤두박질치면서 "다음 달까지 조회수가 회복되지 않으면 계약을 해지하겠다"는 통보를 받게 됩니다. 당장 생계가 막막해진 A씨는 극심한 불안 속에서 절박한 생계형 동기로 AI 모작을 결심하게 됩니다.
...
초기 고소 단계에서 A씨는 "AI 생성물이라 창작 영역"이라며 반발했으나, 경찰 조사와 재판이 본격화되자 자신의 잘못을 깊이 뉘우쳤습니다. A씨는 해당 캐릭터 등장 분량을 삭제하고 연재를 중단했으며, 원작자 B씨와 디즈니 측에 **합의금 3,000만 원을 지급하고 민·형사상 처벌불원서 합의 타결**을 이루어냈습니다.`,
